...
- Масштабируемый виджет с разными раскладками в зависимости от размера:
  - **1 ряд** — иконка, температура и дата/время в одну строку
  - **2+ ряда (широкий)** — иконка слева, температура и дата/время под ней
  - **Квадрат** — иконка, температура и дата/время столбиком
  - **Очень узкий** — только иконка и температура
- Учитывает **формат 12/24 ч** и **округление температуры** из настроек приложения
...
- Формат времени 12/24 ч (интерфейс, выбор времени, уведомления и виджет)
...
- **home_widget** + **Workmanager** (виджет Android) • **flutter_local_notifications**
