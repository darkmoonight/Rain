...
void main() {
  ...
  group('StatusWeather image paths', () {
    test('returns asset paths for known codes', () {
      ...
      expect(
        statusWeather.getImage7Day(61),
        contains('assets/images/'),
      );
    });

    test('switches day/night icons based on time', () {
      final day = statusWeather.getImageNow(0, '2026-06-05T12:00', '06:00', '18:00');
      final night = statusWeather.getImageNow(0, '2026-06-05T22:00', '06:00', '18:00');
