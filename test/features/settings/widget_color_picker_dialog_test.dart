...
void main() {
  ...
  testWidgets('widget color picker shows transparent option when enabled', (
    tester,
  ) async {
    await pumpRainWidget(
      tester,
    ...
    expect(find.byType(WidgetTransparentOption), findsOneWidget);
    expect(find.text('widgetBackgroundTransparent'.tr), findsOneWidget);
