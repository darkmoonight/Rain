...
class TranslationsElGr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get reload_widget => 'Επαναφόρτωση widget';
	@override String get reload_widget_success => 'Τα widget επαναφορτώθηκαν';
	...
	@override String get reset_all_widget_colors => 'Επαναφορά όλων των χρωμάτων widget';
	@override String get reset_all_widget_colors_success => 'Τα χρώματα widget επαναφέρθηκαν';
	...
	@override String get widget_battery => 'Χρήση μπαταρίας';
	...
	@override String get aqi_help_how_calculated_european => 'Ωριαίος ευρωπαϊκός AQI από Open-Meteo (Copernicus CAMS). Ο συνολικός δείκτης είναι το μέγιστο των μεμονωμένων δεικτών PM2.5, PM10, όζοντος, NO₂ και SO₂. Κλίμακα: 0–20 καλή, 20–40 ικανοποιητική, 40–60 μέτρια, 60–80 κακή, 80–100 πολύ κακή, πάνω από 100 εξαιρετικά κακή.';
	@override String get aqi_help_how_calculated_american => 'Ωριαίος US AQI από Open-Meteo (Copernicus CAMS). Ο συνολικός δείκτης είναι το μέγιστο των μεμονωμένων δεικτών PM2.5, PM10, όζοντος, NO₂, SO₂ και CO. Κλίμακα: 0–50 καλή, 51–100 μέτρια, 101–150 ανθυγιεινή για ευαίσθητες ομάδες, 151–200 ανθυγιεινή, 201–300 πολύ ανθυγιεινή, 301–500 επικίνδυνη.';
	...
	@override String get font_system => 'Προεπιλογή πλατφόρμας';
	@override String get font_ubuntu => 'Ubuntu (εφαρμογή)';
	@override String get font_work_sans => 'Work Sans';
	@override String get weather_icon_theme => 'Εικονίδια καιρού';
	@override String get weather_icon_classic => 'Κλασικό';
	@override String get metric_help_apparent_temperature_min => 'Χαμηλότερη αισθητή θερμοκρασία της ημέρας, με συνδυασμό ψυχραισθησίας, υγρασίας και ηλιακής ακτινοβολίας.';
	@override String get metric_help_apparent_temperature_max => 'Υψηλότερη αισθητή θερμοκρασία της ημέρας, με συνδυασμό ψυχραισθησίας, υγρασίας και ηλιακής ακτινοβολίας.';
	@override String get metric_help_uv_index => 'Ένταση υπεριώδους ακτινοβολίας. Υψηλότερες τιμές σημαίνουν ταχύτερο ηλιακό έγκαυμα και μεγαλύτερο κίνδυνο για τα μάτια.';
	@override String get metric_help_direction => 'Κατεύθυνση ανέμου στον πυξίδα — από πού φυσάει ο άνεμος.';
	@override String get metric_help_wind => 'Μέση ταχύτητα ανέμου σε ύψος 10 μ από το έδαφος.';
	@override String get metric_help_wind_gusts => 'Σύντομες ριπές — μέγιστη ταχύτητα ανέμου στην περίοδο.';
	@override String get metric_help_precipitation_probability => 'Πιθανότητα μετρήσιμων βροχοπτώσεων αυτή την ώρα ή ημέρα.';
	@override String get metric_help_rain => 'Μόνο υγρή βροχή (χωρίς χιόνι).';
	@override String get metric_help_precipitation => 'Συνολικό νερό από βροχή και χιόνι (το χιόνι ως ισοδύναμο νερού).';
	@override String get metric_help_dewpoint => 'Θερμοκρασία κορεσμού του αέρα. Όσο πιο κοντά στη θερμοκρασία αέρα, τόσο πιο υγρός ο καιρός.';
	@override String get metric_help_feels => 'Αισθητή θερμοκρασία αυτή την ώρα από υγρασία, άνεμο και ήλιο.';
	@override String get metric_help_visibility => 'Μέγιστη οριζόντια απόσταση όπου διακρίνονται αντικείμενα.';
	@override String get metric_help_evaporation => 'Εξάτμιση από έδαφος και φυτά· μοντελοποιημένη για την τοποθεσία (1 mm/ώ ≈ 1 λ ανά m²).';
	@override String get metric_help_humidity => 'Σχετική υγρασία σε ύψος 2 μ — υγρασία ως ποσοστό κορεσμού.';
	@override String get metric_help_cloudcover => 'Μερίδιο ουρανού καλυμμένο από σύννεφα (0% καθαρός, 100% νεφελώδης).';
	@override String get metric_help_pressure => 'Ατμοσφαιρική πίεση σε επίπεδο θαλάσσης. Η πτώση συχνά προμηνύει επιδείνωση καιρού.';
	...
	@override String get color_palette_green => 'Πράσινο';
	@override String get color_palette_orange => 'Πορτοκαλί';
	@override String get color_palette_red => 'Κόκκινο';
	@override String get color_palette_pink => 'Ροζ';
	@override String get color_palette_cyan => 'Κυανό';
	@override String get color_palette_indigo => 'Ινδικό';
	@override String get color_palette_sky => 'Ουρανί';
	@override String get color_palette_mint => 'Μέντα';
	@override String get color_palette_lime => 'Λάιμ';
	@override String get color_palette_amber => 'Κεχριμπάρι';
	@override String get color_palette_coral => 'Κοραλί';
	@override String get color_palette_crimson => 'Βυσσινί';
	@override String get color_palette_rose => 'Τριαντάφυλλο';
	@override String get color_palette_brown => 'Καφέ';
	@override String get color_palette_slate => 'Σκούρο γκρι';
	@override String get color_palette_navy => 'Ναυτικό';
	@override String get color_palette_gold => 'Χρυσό';
	@override String get color_palette_grape => 'Σταφύλι';
	@override String get color_palette_forest => 'Δάσος';
	@override String get color_palette_turquoise => 'Τυρκουάζ';
	@override String get color_palette_violet => 'Βιολετί';
	@override String get color_palette_lavender => 'Λεβάντα';
	@override String get color_palette_lilac => 'Λιλά';
	@override String get color_palette_orchid => 'Ορχιδέα';
	@override String get color_palette_magenta => 'Ματζέντα';
	@override String get color_palette_raspberry => 'Βατόμουρο';
	@override String get color_palette_wine => 'Κρασί';
	@override String get color_palette_maroon => 'Καστανό';
	@override String get color_palette_peach => 'Ροδάκινο';
	@override String get color_palette_copper => 'Χαλκός';
	@override String get color_palette_yellow => 'Κίτρινο';
	@override String get color_palette_olive => 'Ελιά';
	@override String get color_palette_sage => 'Φασκόμηλο';
	@override String get color_palette_emerald => 'Σμαράγδι';
	@override String get color_palette_jade => 'Νεφρίτης';
	@override String get color_palette_aqua => 'Γαλάζιο νερό';
	@override String get color_palette_azure => 'Γαλάζιο';
	@override String get color_palette_cobalt => 'Κοβάλτιο';
...
extension on TranslationsElGr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'license' => 'Άδειες',
			'reload_widget' => 'Επαναφόρτωση widget',
			'reload_widget_success' => 'Τα widget επαναφορτώθηκαν',
			...
			'reset_all_widget_colors' => 'Επαναφορά όλων των χρωμάτων widget',
			'reset_all_widget_colors_success' => 'Τα χρώματα widget επαναφέρθηκαν',
			...
			'widget_battery' => 'Χρήση μπαταρίας',
			...
			'aqi_help_how_calculated_european' => 'Ωριαίος ευρωπαϊκός AQI από Open-Meteo (Copernicus CAMS). Ο συνολικός δείκτης είναι το μέγιστο των μεμονωμένων δεικτών PM2.5, PM10, όζοντος, NO₂ και SO₂. Κλίμακα: 0–20 καλή, 20–40 ικανοποιητική, 40–60 μέτρια, 60–80 κακή, 80–100 πολύ κακή, πάνω από 100 εξαιρετικά κακή.',
			'aqi_help_how_calculated_american' => 'Ωριαίος US AQI από Open-Meteo (Copernicus CAMS). Ο συνολικός δείκτης είναι το μέγιστο των μεμονωμένων δεικτών PM2.5, PM10, όζοντος, NO₂, SO₂ και CO. Κλίμακα: 0–50 καλή, 51–100 μέτρια, 101–150 ανθυγιεινή για ευαίσθητες ομάδες, 151–200 ανθυγιεινή, 201–300 πολύ ανθυγιεινή, 301–500 επικίνδυνη.',
			...
			'font_system' => 'Προεπιλογή πλατφόρμας',
			'font_ubuntu' => 'Ubuntu (εφαρμογή)',
			'font_work_sans' => 'Work Sans',
			'weather_icon_theme' => 'Εικονίδια καιρού',
			'weather_icon_classic' => 'Κλασικό',
			'metric_help_apparent_temperature_min' => 'Χαμηλότερη αισθητή θερμοκρασία της ημέρας, με συνδυασμό ψυχραισθησίας, υγρασίας και ηλιακής ακτινοβολίας.',
			'metric_help_apparent_temperature_max' => 'Υψηλότερη αισθητή θερμοκρασία της ημέρας, με συνδυασμό ψυχραισθησίας, υγρασίας και ηλιακής ακτινοβολίας.',
			'metric_help_uv_index' => 'Ένταση υπεριώδους ακτινοβολίας. Υψηλότερες τιμές σημαίνουν ταχύτερο ηλιακό έγκαυμα και μεγαλύτερο κίνδυνο για τα μάτια.',
			'metric_help_direction' => 'Κατεύθυνση ανέμου στον πυξίδα — από πού φυσάει ο άνεμος.',
			'metric_help_wind' => 'Μέση ταχύτητα ανέμου σε ύψος 10 μ από το έδαφος.',
			'metric_help_wind_gusts' => 'Σύντομες ριπές — μέγιστη ταχύτητα ανέμου στην περίοδο.',
			'metric_help_precipitation_probability' => 'Πιθανότητα μετρήσιμων βροχοπτώσεων αυτή την ώρα ή ημέρα.',
			'metric_help_rain' => 'Μόνο υγρή βροχή (χωρίς χιόνι).',
			'metric_help_precipitation' => 'Συνολικό νερό από βροχή και χιόνι (το χιόνι ως ισοδύναμο νερού).',
			'metric_help_dewpoint' => 'Θερμοκρασία κορεσμού του αέρα. Όσο πιο κοντά στη θερμοκρασία αέρα, τόσο πιο υγρός ο καιρός.',
			'metric_help_feels' => 'Αισθητή θερμοκρασία αυτή την ώρα από υγρασία, άνεμο και ήλιο.',
			'metric_help_visibility' => 'Μέγιστη οριζόντια απόσταση όπου διακρίνονται αντικείμενα.',
			'metric_help_evaporation' => 'Εξάτμιση από έδαφος και φυτά· μοντελοποιημένη για την τοποθεσία (1 mm/ώ ≈ 1 λ ανά m²).',
			'metric_help_humidity' => 'Σχετική υγρασία σε ύψος 2 μ — υγρασία ως ποσοστό κορεσμού.',
			'metric_help_cloudcover' => 'Μερίδιο ουρανού καλυμμένο από σύννεφα (0% καθαρός, 100% νεφελώδης).',
			'metric_help_pressure' => 'Ατμοσφαιρική πίεση σε επίπεδο θαλάσσης. Η πτώση συχνά προμηνύει επιδείνωση καιρού.',
			...
			'color_palette_green' => 'Πράσινο',
			'color_palette_orange' => 'Πορτοκαλί',
			'color_palette_red' => 'Κόκκινο',
			'color_palette_pink' => 'Ροζ',
			'color_palette_cyan' => 'Κυανό',
			'color_palette_indigo' => 'Ινδικό',
			'color_palette_sky' => 'Ουρανί',
			'color_palette_mint' => 'Μέντα',
			'color_palette_lime' => 'Λάιμ',
			'color_palette_amber' => 'Κεχριμπάρι',
			'color_palette_coral' => 'Κοραλί',
			'color_palette_crimson' => 'Βυσσινί',
			'color_palette_rose' => 'Τριαντάφυλλο',
			'color_palette_brown' => 'Καφέ',
			'color_palette_slate' => 'Σκούρο γκρι',
			'color_palette_navy' => 'Ναυτικό',
			'color_palette_gold' => 'Χρυσό',
			'color_palette_grape' => 'Σταφύλι',
			'color_palette_forest' => 'Δάσος',
			'color_palette_turquoise' => 'Τυρκουάζ',
			'color_palette_violet' => 'Βιολετί',
			'color_palette_lavender' => 'Λεβάντα',
			'color_palette_lilac' => 'Λιλά',
			'color_palette_orchid' => 'Ορχιδέα',
			'color_palette_magenta' => 'Ματζέντα',
			'color_palette_raspberry' => 'Βατόμουρο',
			'color_palette_wine' => 'Κρασί',
			'color_palette_maroon' => 'Καστανό',
			'color_palette_peach' => 'Ροδάκινο',
			'color_palette_copper' => 'Χαλκός',
			'color_palette_yellow' => 'Κίτρινο',
			'color_palette_olive' => 'Ελιά',
			'color_palette_sage' => 'Φασκόμηλο',
			'color_palette_emerald' => 'Σμαράγδι',
			'color_palette_jade' => 'Νεφρίτης',
			'color_palette_aqua' => 'Γαλάζιο νερό',
			'color_palette_azure' => 'Γαλάζιο',
			'color_palette_cobalt' => 'Κοβάλτιο',
