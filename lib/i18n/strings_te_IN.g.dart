...
class TranslationsTeIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get color_palette_green => 'ఆకుపచ్చ';
	@override String get color_palette_orange => 'నారింజ';
	@override String get color_palette_red => 'ఎరుపు';
	@override String get color_palette_pink => 'గులాబీ';
	@override String get color_palette_cyan => 'సియాన్';
	@override String get color_palette_indigo => 'ఇండిగో';
	@override String get color_palette_sky => 'ఆకాశం';
	@override String get color_palette_mint => 'పుదీనా';
	@override String get color_palette_lime => 'నిమ్మ';
	@override String get color_palette_amber => 'అంబర్';
	@override String get color_palette_coral => 'పవళం';
	@override String get color_palette_crimson => 'గాఢ ఎరుపు';
	@override String get color_palette_rose => 'గులాబం';
	@override String get color_palette_brown => 'మట్టి రంగు';
	@override String get color_palette_slate => 'తెలుపు';
	@override String get color_palette_navy => 'సముద్ర నీలం';
	@override String get color_palette_gold => 'బంగారం';
	...
	@override String get color_palette_magenta => 'మెజంటా';
	@override String get color_palette_raspberry => 'రాస్ప్బరి';
	@override String get color_palette_wine => 'వైన్ రంగు';
	@override String get color_palette_maroon => 'మేరూన్';
	@override String get color_palette_peach => 'పీచ్';
	@override String get color_palette_copper => 'తాంబు';
	@override String get color_palette_yellow => 'పీల';
	@override String get color_palette_olive => 'ఆలివ్';
	@override String get color_palette_sage => 'సేజ్';
	@override String get color_palette_emerald => 'మరగదం';
	@override String get color_palette_jade => 'జేడ్';
	@override String get color_palette_aqua => 'నీటి రంగు';
	@override String get color_palette_azure => 'నీలం';
	@override String get color_palette_cobalt => 'కోబాల్ట్';
...
extension on TranslationsTeIn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'color_palette_green' => 'ఆకుపచ్చ',
			'color_palette_orange' => 'నారింజ',
			'color_palette_red' => 'ఎరుపు',
			'color_palette_pink' => 'గులాబీ',
			'color_palette_cyan' => 'సియాన్',
			'color_palette_indigo' => 'ఇండిగో',
			'color_palette_sky' => 'ఆకాశం',
			'color_palette_mint' => 'పుదీనా',
			'color_palette_lime' => 'నిమ్మ',
			'color_palette_amber' => 'అంబర్',
			'color_palette_coral' => 'పవళం',
			'color_palette_crimson' => 'గాఢ ఎరుపు',
			'color_palette_rose' => 'గులాబం',
			'color_palette_brown' => 'మట్టి రంగు',
			'color_palette_slate' => 'తెలుపు',
			'color_palette_navy' => 'సముద్ర నీలం',
			'color_palette_gold' => 'బంగారం',
			...
			'color_palette_magenta' => 'మెజంటా',
			'color_palette_raspberry' => 'రాస్ప్బరి',
			'color_palette_wine' => 'వైన్ రంగు',
			'color_palette_maroon' => 'మేరూన్',
			'color_palette_peach' => 'పీచ్',
			'color_palette_copper' => 'తాంబు',
			'color_palette_yellow' => 'పీల',
			'color_palette_olive' => 'ఆలివ్',
			'color_palette_sage' => 'సేజ్',
			'color_palette_emerald' => 'మరగదం',
			'color_palette_jade' => 'జేడ్',
			'color_palette_aqua' => 'నీటి రంగు',
			'color_palette_azure' => 'నీలం',
			'color_palette_cobalt' => 'కోబాల్ట్',
