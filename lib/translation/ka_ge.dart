class KaGe {
  Map<String, String> get messages => {
    ...
    'next': 'შემდეგ',
    'skip': 'გამოტოვება',
    'editCityHint': 'ქალაქის ინფორმაციის რედაქტირება',
    'createCityHint': 'მოძებნეთ ან შეიყვანეთ ქალაქის მონაცემები ხელით',
    'unsavedChanges': 'შეუნახავი ცვლილებები',
    'discardChanges': 'ნამდვილად გსურთ ცვლილებების გაუქმება?',
    'discard': 'გაუქმება',
    'save': 'შენახვა',
    'ready': 'მზადაა',
    'search': 'ძიება...',
