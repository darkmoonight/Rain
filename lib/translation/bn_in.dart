class BnIn {
  Map<String, String> get messages => {
    ...
    'next': 'পরবর্তী',
    'skip': 'এড়িয়ে যান',
    'editCityHint': 'শহরের তথ্য সম্পাদনা করুন',
    'createCityHint': 'শহরের তথ্য অনুসন্ধান করুন বা ম্যানুয়ালি লিখুন',
    'unsavedChanges': 'সংরক্ষণ না করা পরিবর্তন',
    'discardChanges':
        'আপনি কি নিশ্চিত যে আপনি আপনার পরিবর্তনগুলি বাতিল করতে চান?',
    'discard': 'বাতিল',
    'save': 'সংরক্ষণ',
    'ready': 'প্রস্তুত',
    'search': 'অনুসন্ধান...',
