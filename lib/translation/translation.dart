...
class Translation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'ur_PK': {
          'start': 'شروع',
          'description':
              'موسمی توقعات فراہم کرنے والا ایپ ہے جو واقعی وقت میں توقعات فراہم کرتا ہے، ساتھ ہی گھنٹے بھر کے، روزانے اور ہفتے کے توقعات کسی بھی مقام کے لئے۔',
          'name': 'موسم',
          'search': 'تلاش کریں...',
        ...
        'ka_GE': {
          'start': 'დაიწყე',
          'description': 'ამჟამაჟამიდებული პროგნოზის გაცვალე, და საათის, დღისა და კვირის პროგნოზები ნებისმიემ ადგილისთვის.',
          'name': 'ამინდი',
          'search': 'ძიება...',
          'loading': 'იტვირთება...',
          'searchCity': 'თქვენი ქალაქი მოძიებე',
          'humidity': 'საშუალო სიხშირე',
          'wind': 'ქანდაკა',
          'visibility': 'ხედვა',
          'feels': 'შეუთავავეთ',
          'evaporation': 'გაყოვნება',
          'precipitation': 'წვავება',
          'direction': 'მიმართულება',
          'pressure': 'წონა',
          'rain': 'წვავება',
          'clear_sky': 'წყალბურული ცივი',
          'cloudy': 'ღრუბელი',
          'overcast': 'წაშია',
          'fog': 'ღრუბელი',
          'drizzle': 'მწვავება',
          'drizzling_rain': 'გვაჩუქა მწვავება',
          'freezing_rain': 'გვაჩუქა წვავება',
          'heavy_rains': 'წვავება სტიკის აღწერილი',
          'snow': 'თოვლი',
          'thunderstorm': 'გრძელი წვავება',
          'kph': 'კმ/წმ',
          'mph': 'მილი/წმ',
          'mi': 'მილი',
          'km': 'კმ',
          ...
          'on_inter': 'დაურთეთ ინტერნეტი, რათა წვავებების მეტეოროლოგიულ ინფორმაციას წამოიიტანოთ.',
          'location': 'მდებარეობა',
          'no_location': 'ჩართეთ მდებარეობის სერვისი, რათა მდებარეობის ამინდი მიიღოთ.',
          'theme': 'თემა',
          'low': 'დაბალი',
          'high': 'მაღალი',
          'normal': 'ჩვენებალი',
          ...
          'city': 'ქალაქი',
          'district': 'უბანი',
          'noWeatherCard': 'დაამატე ქალაქი',
          'deletedCardWeather': 'ქალაქის წაშლა',
          'deletedCardWeatherQuery': 'ნამცი გყლაპაუი ქალაქი წაშლა გსურთ?',
          'delete': 'წაშლა',
          'cancel': 'გაუქმება',
          'time': 'დრო ქალაქში',
          'validateName': 'გთხოვთ, შეიყვანეთ სახელი',
          'measurements': 'სისტემის სიდიანე',
          'degrees': 'დარება',
          'celsius': 'ცელსი',
          'fahrenheit': 'ფარენგაიტი',
          'imperial': 'იმპერიალური',
          'metric': 'მეტრიკული',
          'validateValue': 'გთხოვთ, შეიყვანეთ მნიშვნელობა',
          'validateNumber': 'გთხოვთ, შეიყვანეთ სწორი რიცხვი',
          'validate90': 'მნიშვნელობა უნდა იყოს -90-დან 90-მდე',
          'validate180': 'მნიშვნელობა უნდა იყოს -180-დან 180-მდე',
          'notifications': 'შეტყობინებები',
          'sunrise': 'მზის ამოღლება',
          'sunset': 'მზის ჩასვლა',
          'timeformat': 'დროს ფორმატი',
          '12': '12-საათი',
          '24': '24-საათი',
          'cloudcover': 'ღრუბელი',
          'uvIndex': 'UV-ინდექსი',
          ...
          'uvAverage': 'საშუალო',
          'uvHigh': 'მაღალი',
          'uvVeryHigh': 'ძლევა მაღალი',
          'uvExtreme': 'ძლევა ზედა',
          'weatherMore': '12-დღიანი ამინდის პროგნოზი',
          'windgusts': 'შემოწმებები',
          'north': 'ჩრდილოეთი',
          'northeast': 'ჩრდილოეთ-სამხე',
          'east': 'სამხე',
          'southeast': 'სამხე-სამხე',
          'south': 'სამხე',
          'southwest': 'სამხე-ჩრდილოეთ',
          'west': 'ჩრდილოეთ',
          'northwest': 'ჩრდილოეთ-ჩრდილოეთ',
          'project': 'პროექტი ჩართულია',
          'version': 'აპლიკაციის ვერსია',
          'precipitationProbability': 'წვავების ალადება',
          'apparentTemperatureMin': 'მინიმალუს ხსნა ტემპერატურა',
          'apparentTemperatureMax': 'მაქსიმუმ ხსნა ტემპერატურა',
          'amoledTheme': 'AMOLED-თემა',
          'appearance': 'გამოსახულება',
          'functions': 'ფუნქციები',
          'data': 'მონაცემები',
          'language': 'ენა',
          'timeRange': 'სიხასირე (საათებში)',
          'timeStart': 'დაწყება',
          'timeEnd': 'დასრულება',
          'support': 'მხარდაჭერა',
          'system': 'სისტემა',
          ...
          'dewpoint': 'რვანქენა',
          'shortwaveRadiation': 'მოცილე დიანი',
          'W/m2': 'W/m2',
        },
        'bn_IN': {
          'start': 'শুরু করুন',
